...
function load_scaled_data()
    _3Genes_AND = BSON.load(datadir("simulations","competition_divergence","cleanup","3Genes_AND_Restrictions_3.4.2023.2.49.14.497.bson"))
    ...
    _3Genes_OR = BSON.load(datadir("simulations","competition_divergence","cleanup","3Genes_OR_Restrictions_3.4.2023.3.15.28.889.bson"))
    ...
    _3Genes_NO = BSON.load(datadir("simulations","competition_divergence","cleanup","3Genes_NO_Restrictions_3.4.2023.2.27.15.692.bson"))
...
savefig(datadir("figures","competition_divergence","3Genes_Divergence_Scaled.tex"))



function print_all_data()
    filename = "3Genes_NO_Restrictions_3.4.2023.2.27.15.692.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "3Genes_AND_Restrictions_3.4.2023.2.49.14.497.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "3Genes_OR_Restrictions_3.4.2023.3.15.28.889.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "7Genes_NO_Restrictions_3.4.2023.3.38.21.119.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "7Genes_Example1_3.4.2023.4.31.17.226.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "7Genes_Example2_3.4.2023.5.29.23.058.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "7Genes_NK_Fitness_1_3.4.2023.6.35.13.179.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
    filename = "7Genes_NK_Fitness_2_7.4.2023.21.29.47.666.bson"
    thisdf = BSON.load(datadir("simulations","competition_divergence","cleanup",filename))
    println("Simulation ",filename," has:")
    println("TTP: ",mean(thisdf["TTP"]))
    println("Detecting time: ",mean(thisdf["detecting_time"]))
