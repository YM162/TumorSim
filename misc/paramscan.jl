...
#We run the simulation
 steps=1
adata, _ = paramscan(parameters, model_init; adata = agent_collect, agent_step! = agent_step!, model_step! = model_step!, n = steps, parallel = false, showprogress = true,include_constants=true)
