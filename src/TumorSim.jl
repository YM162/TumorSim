module TumorSim
export create_scenario, model_init, agent_step!, model_step!,genotype_fraction_function_generator, bit_2_int, launch_simulation, plot_genotypes, simulate, Treatment, Scenario
